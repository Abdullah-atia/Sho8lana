...
function Header2() {
  return (
    <div className={`${styles.main} mt-20 flex flex-row  h-full max-h-full `}>
      <div className="basis-1/3 m-5 " data-aos="fade-up" data-aos-delay="400">
        <h1 className={`${styles.title} text-6xl `}>
          Find Your Perfect <span>Freelancer</span> Quick and Easy
        </h1>
        <div className="flex bg-white 	rounded-full 	justify-between mt-10">
          <div>
            <input
              className={`${styles.bar} m-2 rounded-full border-0 outline-none focus:outline-none focus:ring-0`}
              type="text"
          ...
          <div>
            <button>
              <div className="flex items-center bg-green-400 p-3 mr-auto ml-0 	rounded-full text-slate-50 pr-2.5 justify-between	">
                <img
                  className=""
                  src="./assets/images/search.svg"
                  alt="search_icon"
                />
                <p className="pr-2.5">Search</p>
              </div>
            </button>
          </div>
        </div>
        <div className="mt-40 d-flex flex-column flex-sm-row flex-wrap gap-4 align-items-center">
          <div className="d-flex gap-3 align-items-center">
            <div className="hero-group-img-wrapper flex">
              <img
                src="./assets/images/gp-1.png"
                className="hero-group-img"
                style={{ marginRight: "-25px" }}
                alt="pop"
              />
              <img
                src="./assets/images/gp-2.png"
                className="hero-group-img"
                style={{ marginRight: "-25px" }}
                alt="pop"
              />
              <img
                src="./assets/images/gp-3.png"
                className="hero-group-img"
                alt="pop"
              />
            </div>
            <div>
              <h3 className="text-white hero-counter-title fw-bold">39M+</h3>
              <p className="text-white">Happy Customers</p>
            </div>
          </div>
          <div className="hero-rating border-l-2 border-secondary-50 pl-5	">
            <h3
              className="text-white hero-counter-title fw-bold"
              style={{ fontSize: "24px" }}
            >
              4.9
            </h3>
      ...
      <img
        className="basis-2/3 max-w-fit ml-44"
