      ...
      <ul className="sidebar-nav p-3 overflow-y-auto">
        ...
        <li className="sidebar-nav-item">
          <Link
            to="/allCategory"
            className={
              active === "category" ? "sidebarNavLink active" : "sidebarNavLink"
            }
          >
        ...
        {/* <li className="sidebar-nav-item">
          <Link
            to="/projects"
            className={
              active === "projects" ? "sidebarNavLink active" : "sidebarNavLink"
            }
          >
        ...
        <li className="sidebar-nav-item">
          <Link
            to="/allSkills"
            className={
              active === "Skills" ? "sidebarNavLink active" : "sidebarNavLink"
            }
          >
            <SiJirasoftware style={{ width: "20px", height: "20px" }} />
            All Skills
          </Link>
        </li>
        <li className="sidebar-nav-item">
