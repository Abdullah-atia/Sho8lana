    ...
    <div>
      <div>
        {/* <header className="d-flex dashboard-header justify-content-between align-items-center p-4 bg-white">
                <div>
                  <button className="navbar-toggler d-block d-xl-none shadow-none border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">
                    <span></span>
                  </button>
                </div>
                <div>
                  <div className="dashboardHeaderBtns d-flex gap-3">
                    ...
                    <div className="d-none d-md-block">
                      <button className="dashboardHeaderBtn">
                        ...
                        <span className="headerBtnBadge">5</span>
                      </button>
                    </div>
                    <div className="dropdown d-none d-md-block">
                      <button type="button" data-bs-toggle="dropdown" aria-expanded="false" className="dashboardHeaderBtn dropdown-toggle">
                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="headerBtnBadge">8</span>
                      </button>
                    ...
                    <div className="dropdown">
                      <button className="dropdown-toggle dashboardHeaderBtn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    {projects.map((item) =>{
                      return (
                        <tr key={item.id}>
                          ...
                          <td className="textDark200">$15</td>
                          <td>
