    ...
    <div className="row">
      <div className="col-md-12 col-xl-6 mt-n5">
        <div>
          ...
          <div className="mt60 d-flex flex-column flex-sm-row flex-wrap gap-4 ">
            <div className="d-flex gap-3 align-items-center">
              <div className="heroGroupImgWrapper">
                <img src="../images/gp-1.png" className="heroGroupImg" alt="" />
                <img src="../images/gp-2.png" className="heroGroupImg" alt="" />
                <img src="../images/gp-3.png" className="heroGroupImg" alt="" />
              </div>
              <div>
