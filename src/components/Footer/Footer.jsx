function Footer() {
    return (
      <footer>
        <div className="bgdark300 pt110">
          <div className="container">
            {/* Newsletter */}
            <div
              className="footerNewsLetter pb60 aos-init"
              data-aos="fade-right"
              ...
              <div className="row justify-content-between row-gap-4">
                <div className="col-lg-6 col-xl-4">
                  <div>
                    ...
                    <p className="text-white">
                      ...
                      at its layout the point of using lorem varius sit amet
                      ipsum.
                    </p>
                  </div>
                </div>
                <div className="col-lg-6 col-xl-6">
                  <div className="d-flex flex-column justify-content-end">
                    ...
                    <p className="footerNewsletterDesc mb30">
                      We'll keep you updated with the best new jobs.
                    </p>
                    <form>
                      <div className="relative footerNewsletterForm d-flex align-items-center justify-content-between">
                        <input
                          type="text"
                          className="form-control shadow-none"
                          placeholder="Enter your email address"
                        />
                        <button className="footerNewsletterBtn">
                          Subscribe
                        </button>
                      </div>
                    </form>
            ...
            {/* Footer Widgets */}
            <div className="footer-widgets py60">
              <div className="row justify-content-between row-gap-4">
                <div
                  className="col-md-6 col-xl-3 aos-init"
                  data-aos="fade-up"
                  data-aos-duration={1000}
                  data-aos-easing="linear"
                >
                  <div className="mb-5">
                    <h3 className="footerWidgetTitle fw-bold mb-4">
                      Download App
                    </h3>
                    <ul className="footerInfoWidgetItem p-0">
                      <li className="d-flex gap-3 align-items-center py-2 footerInfoWidgetItem-item">
                        <svg
                          width={17}
                          height={16}
                          viewBox="0 0 17 16"
                      ...
                      <li className="d-flex gap-3 align-items-center py-2 footerInfoWidgetItem-item">
                        ...
                        374 A Tower, William Road Blvd <br />, Melbourne 2721,
                        IL, USA
                      </li>
                    </ul>
                  </div>
                ...
                <div className="col-md-6 col-xl-3">
                  ...
                  >
                    ...
                    <nav>
                      <ul className="footerNavList list-unstyled">
                        <li className="footerNavListItem py-1">
                          <a
                            href="services.html"
                            className="footerNavLink d-flex gap-2 align-items-center"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width={13}
                        ...
                        <li className="footerNavListItem py-2">
                          <a
                            href="services.html"
                            className="footerNavLink d-flex gap-2 align-items-center"
                          >
                ...
                <div className="col-md-6 col-xl-3">
                  <div
                    ...
                    className="aos-init"
                  >
                    <h3 className="footerWidgetTitle fw-bold mb-4">About</h3>
                    <nav>
                      <ul className="footerNavList list-unstyled">
                        <li className="footerNavListItem py-1">
                          <a
        ...
        <div className="footerCopyright py-4">
          <div className="container">
